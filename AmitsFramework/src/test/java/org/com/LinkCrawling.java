...
public class LinkCrawling extends origin{
 ...
 mylist = driver.findElements(By.tagName("a"));
		...
		for(WebElement alllink:mylist){
			 if(alllink.getAttribute("href")!=null && alllink.getAttribute("href").startsWith("https") ){
	        ...
	        System.out.println("URL: " + alllink.getAttribute("href")+ " returned " + isLinkBroken(new URL(alllink.getAttribute("href"))));
